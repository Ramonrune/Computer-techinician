...
<body>
	...
	<div id="corpo">
		...
		$resultado2 = mysqli_query ( $conexao, "INSERT INTO lixeira values(null,'$nome','$email',null,null,'$assunto',null);" );
		
		$resultado = mysqli_query ( $conexao, "DELETE FROM Solicitacao WHERE id=$id" );
