...
<body style="min-width: 1000px;
		...
		<div id="espacologin">
			<div id="arealogin">
				<div class="login">
					...
					<br> <br>
					<br>
					<br> Faça Login Para Acessar a Área de <br>Administração: <br> <br>
					<br> <br>
					<form method="post" action="validalogin.php">
						Numero de Identificação:<br> <input type="text" name="ni"
							placeholder="NI"> <br> <br> Senha:<br> <input type="password"
							name="senha" placeholder="•••••••••"> <br> <br> <br> <input
							type="submit" value="Entrar" class="entrar"> <br>
						<br> <a href="../recuperarsenha.php"><font size="1" color="darkred">Esqueci
								Minha Senha</font></a>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="../oquefazer.php"><font size="1" color="darkred">Não Tenho Acesso - O que Fazer ?</font></a>
					</form>
	...
	<div id="rodape" align="center" style="height:40%;">
		<br>
		<address>

			Rua Vereador Sergio Leopoldino Alves, 500 - Cidade Industrial<br>
			CEP: 13456-166 - Santa Bárbara d'Oeste - SP<br> Telefone: (19)
			3499-1450 - senaisantabarbara@sp.senai.br <br> ©2015 - 2015 CFP 5.14
