...
<body>
	...
	<div id="corpo">
 	...
 	<?php
		...
		include "../Conexao.inc";
		@$resultado = mysqli_query ( $conexao, "SELECT * FROM LixeiraNoticia,Usuario WHERE LixeiraNoticia.autor = Usuario.NI" );
		...
		while ( $row = mysqli_fetch_array ( $resultado ) ) {
			...
			if($row["data_final"]==$dataatual){
				$r = mysqli_query ( $conexao, "DELETE FROM LixeiraNoticia WHERE Id=$row[Id]" );
			}
			echo "</tr>";
		}
		...
		?>
			...
			<a class="botao" href="gestaodenoticias.php">Noticias</a>
