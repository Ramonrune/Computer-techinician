...
<body>
	...
	<div id="corpo">
		<div>
			...
			<?php
			//aqui são mostradas as mensagens que estão cadastradas
			include "../Conexao.inc";
			...
			if ($numero == 0) {
					echo '<tr><td colspan="6" align="center">' . "Nenhuma Mensagem Enviada.</td></tr>";
			}
			while ( $row = mysqli_fetch_array ( $resultado ) ) {
				$id = $row ["id"];
				
				echo "<form action='mensagemcompleta.php?id=$id' method='GET'>";
			...
			if($row['novo']=='1'){
				...
				echo "</td>";
				echo "<td><input type='submit' value='Ver' style='width:40px;'>&nbsp;&nbsp;<a href='excluimensagem.php?id=$row[id]'><img src='../Recursos/Imagens/delecao.png'></a></td>";
