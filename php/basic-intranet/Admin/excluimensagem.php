...
<body>
	...
	<div id="corpo">
		<div>
			...
			<br><br>
		<?php
		//aqui é pego a id da mensagem de contato que foi clicada e após isso ela é deletada do banco de
		//dados
		//antes de ser deletada ela é inserida em uma lixeira
		include "../Conexao.inc";
		if(!isset($_GET["id"])){
			echo "Informe Uma Mensagem Válida.";
			echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
		}
		if(isset($_GET["id"])){
		$id = $_GET ["id"];
		$resultado1 = mysqli_query ( $conexao, "SELECT * FROM contato WHERE id = $id" );
		if ($resultado1 === FALSE) {
			die ( mysql_error () );
		}
		...
		$resultado2 = mysqli_query ( $conexao, "INSERT INTO lixeira values($id1,'$nome','$email','$ddd','$telefone','$assunto','$mensagem');" );
		
		$resultado = mysqli_query ( $conexao, "DELETE FROM contato WHERE id=$id" );
